...
export const fetchCourseDetails = async (courseId) => {
  try {
    ...
    if (!res.ok)
      throw new Error(courseData.error || "Kurs bilgileri alınamadı");
    return courseData;
  } catch (error) {
...
export const createCourse = async (formData) => {
  try {
    ...
    if (!res.ok) {
      ...
      throw new Error(errorData.message || "Course creation failed");
    }
    return await res.json();
  } catch (error) {
...
export const fetchQuestionDetails = async (questionId) => {
  try {
    ...
    if (!res.ok)
      throw new Error(questionData.error || "Soru bilgileri alınamadı");
    return questionData;
  } catch (error) {
...
export const createQuestion = async (formData) => {
  try {
    ...
    if (!res.ok) {
      const errorData = await res.json();
      throw new Error(errorData.message || "Question creation failed");
    }
    return await res.json();
  } catch (error) {
